...
if [[ "$WAN22_LAYOUT" == "autodl" ]]; then
  ...
  : "${WAN22_UPSCALE_REPO:=$WAN22_DATA_ROOT/SeedVR2}"
  ...
  : "${WAN22_UPSCALE_MODEL_DIR:=$WAN22_DATA_ROOT/models/seedvr2}"
  : "${WAN22_HOST:=0.0.0.0}"
  : "${WAN22_PORT:=8000}"
else
...
: "${WAN22_UPSCALE_MODEL:=seedvr2_ema_3b_fp8_e4m3fn.safetensors}"
: "${WAN22_UPSCALE_TIMEOUT:=900}"
: "${WAN22_UPSCALE_BATCH:=21}"
: "${WAN22_UPSCALE_CHUNK:=0}"
...
export WAN22_UPSCALE_VENV_DIR WAN22_UPSCALE_REPO WAN22_UPSCALE_PYTHON WAN22_UPSCALE_MODEL_DIR
export WAN22_UPSCALE_MODEL WAN22_UPSCALE_TIMEOUT WAN22_UPSCALE_BATCH WAN22_UPSCALE_CHUNK
